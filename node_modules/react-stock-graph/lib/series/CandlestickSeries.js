...
CandlestickSeries.propTypes = {
	...
	wickProps: _propTypes2.default.object,
	candleClassName: _propTypes2.default.string,
	candleProps: _propTypes2.default.object,
...
function getWicksSVG(props, candleData) {
	var wickProps = props.wickProps;

	var wicks = candleData.map(function (each, idx) {
		var d = each.wick;
		return _react2.default.createElement("path", _extends({ key: idx,
...
function getCandlesSVG(props, candleData) {
	...
	var opacity = props.opacity,
	    ...
	    candleProps = props.candleProps;
	/* eslint-enable react/prop-types */

	var candles = candleData.map(function (d, idx) {
		if (d.width <= 1) return _react2.default.createElement("line", _extends({ className: d.className, key: idx,
			x1: d.x, y1: d.y, x2: d.x, y2: d.y + d.height,
			stroke: d.fill
		}, candleProps));else if (d.height === 0) return _react2.default.createElement("line", _extends({ key: idx,
			x1: d.x, y1: d.y, x2: d.x + d.width, y2: d.y + d.height,
			stroke: d.fill
		}, candleProps));
		return _react2.default.createElement("rect", _extends({ key: idx, className: d.className,
			fillOpacity: opacity,
